...
router
    ...
    .get("/submit/user/:courseId/:assignmentId", [tokenValidator_1.tokenAuthorization, tokenValidator_1.isStudentOrInstructor], assignment_1.default.getAssignmentSubmittedByUser)
    ...
    .patch("/assessment/create/:assignmentId/:submittedAssignmentId", [tokenValidator_1.tokenAuthorization, tokenValidator_1.isInstructor], assignment_1.default.giveGraderToSubmittedAssignment)
