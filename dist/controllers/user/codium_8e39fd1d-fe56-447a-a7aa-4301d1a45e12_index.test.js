...
describe('getMyLearning', () => {
    // If there is an error retrieving the user's learning data, the method should return an internal server error status code (500).
    it('should return an internal server error status code (500) if there is an error retrieving the user\'s learning data', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            user: {
        ...
        const res = {
            ...
            send: function (response) {
                // No need to assert response, as long as status code is 500
            }
        };
