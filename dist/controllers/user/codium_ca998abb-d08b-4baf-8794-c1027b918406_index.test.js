...
describe('getMyLearning', () => {
    // If the user does not exist, the method should return a not found status code (404).
    it('should return a not found status code (404) if the user does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            user: {
        ...
        const res = {
            ...
            send: function (response) {
                // No need to assert response, as long as status code is 404
            }
        };
