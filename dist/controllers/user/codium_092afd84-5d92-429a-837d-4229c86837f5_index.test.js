...
describe('getMyLearning', () => {
    // The method should return a success status code (200) if the user's learning data is retrieved successfully.
    it('should return a success status code (200) if the user\'s learning data is retrieved successfully', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            user: {
        ...
        const res = {
            ...
            send: function (response) {
                // No need to assert response, as long as status code is 200
            }
        };
