...
describe('getMyLearning', () => {
    // The method should return an empty array if the user has no learning data.
    it('should return an empty array if the user has no learning data', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            user: {
