    ...
    addToCart(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!user) {
                    return (0, response_1.sendResponse)(res, statusCode_1.HTTP_STATUS.NOT_FOUND, responseMessage_1.RESPONSE_MESSAGE.NOT_FOUND);
                }
                let cart = yield cart_1.default.getCartByUserId(user._id);
                if (cart.success) {
                    ...
                    cart = yield cart_1.default.addCourseToCartInNewCart(user._id, courseId);
                    if (!cart.success) {
                        return (0, response_1.sendResponse)(res, statusCode_1.HTTP_STATUS.BAD_REQUEST, responseMessage_1.RESPONSE_MESSAGE.SOMETHING_WENT_WRONG);
                    }
                }
    ...
    getCartByUserId(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let cart = yield cart_1.default.getCartByUserIdPopulated(user._id);
                if (!cart.success) {
                    return (0, response_1.sendResponse)(res, statusCode_1.HTTP_STATUS.OK, responseMessage_1.RESPONSE_MESSAGE.NO_CART, []);
                }
                ...
                return (0, response_1.sendResponse)(res, statusCode_1.HTTP_STATUS.OK, responseMessage_1.RESPONSE_MESSAGE.SUCCESSFULLY_GET_ALL_DATA, cart.data);
            }
            catch (error) {
                console.log(error);
                (0, dbLogger_1.databaseLogger)(error.message);
